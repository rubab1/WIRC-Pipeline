...
# Gets objects in SN sky frames for Sex cleaning. 

begin
	string fname, onumber
	real xstar, ystar, xshift, yshift, newx, newy, size, x, y
...
#       set stdimage=imt2048
	...
	wclear ("p0.fits") ; wclear ("p1.fits") ; wclear ("p2.fits")
	wclear ("p3.fits") ; wclear ("p4.fits")
 	wclear ("e0.fits") ; wclear ("e1.fits") ; wclear ("e2.fits")
	wclear ("e3.fits") ; wclear ("e4.fits")
	wclear ("e0.pl")   ; wclear ("e1.pl")   ; wclear ("e2.pl")
	wclear ("e3.pl")   ; wclear ("e4.pl")
...
# Add up the size sorted object masks
	...
	display ("mask_isx_"//onumber//"_c"//chip//".pl", 1, bpmask="BPM", bpdisplay="none", bpcolors="green", overlay="", ocolors="red", erase=yes, border_erase=no, select_frame=yes, repeat=no, fill=yes, zscale=yes, contrast=0.25, zrange=yes, zmask="", nsample=1000, xcenter=0.5, ycenter=0.5, xsize=1., ysize=1., xmag=1., ymag=1., order=0, z1=0., z2=100., ztrans="linear", lutfile="")

	display ("stk_"//onumber//"_c"//chip, 2, bpmask="BPM", bpdisplay="none", bpcolors="green", overlay="", ocolors="red", erase=yes, border_erase=no, select_frame=yes, repeat=no, fill=yes, zscale=yes, contrast=0.25, zrange=yes, zmask="", nsample=1000, xcenter=0.5, ycenter=0.5, xsize=1., ysize=1., xmag=1., ymag=1., order=0, z1=0., z2=100., ztrans="linear", lutfile="")

# Erase unnecessary stacked frame:
