procedure w_sky4 ( p1, p2, p3, p4, p5, p6,chip )
...
#  using sky frames created by 'p_skysub' operating
#  on the off-source frames.
#     
#       This script should be equivalent of p_sky4 for PANIC/RetroCAM
#


begin
	int k
	string stsect, fname, filelist, is2_frame, obj_mask, root_name, sp1, sp2, sp3, sp4, sp5, sp6, date, bp_mask
	real sky3_lev, sky5_lev, obj_lev, xshift, yshift, scale, sky_lev
	...
	if ( access ( "sky_"//sp3//"_"//sp4//"_c"//k//".fits") && access ( "sky_"//sp5//"_"//sp6//"_c"//k//".fits")) {
	  ...
	  imarith ("sky", "/", 1., "sky_"//root_name, title="", divzero=0., hparams="", pixtype="real", calctype="real", verbose=no, noact=no)
